...
hobo_staging_public_subnet_01 = {
  cidr                    = "10.0.1.0/24"
  map_public_ip_on_launch = true
  tags = {
    Name = "Staging Public Subnet 01"
  }
}

hobo_staging_public_subnet_02 = {
  cidr                    = "10.0.2.0/24"
  map_public_ip_on_launch = true
  tags = {
    Name = "Staging Public Subnet 02"
  }
}

hobo_staging_private_subnet_01 = {
  availability_zone       = "ap-northeast-1a"
  cidr                    = "10.0.3.0/24"
  map_public_ip_on_launch = false
  tags = {
    Name = "Staging Private Subnet 01"
  }
}

hobo_staging_private_subnet_02 = {
  availability_zone       = "ap-northeast-1c"
  cidr                    = "10.0.4.0/24"
  map_public_ip_on_launch = false
  tags = {
    Name = "Staging Private Subnet 02"
  }
}

hobo_staging_private_subnet_03 = {
  availability_zone       = "ap-northeast-1d"
  cidr                    = "10.0.5.0/24"
  map_public_ip_on_launch = false
  tags = {
    Name = "Staging Private Subnet 03"
  }
}
